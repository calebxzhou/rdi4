...
public abstract class mExplosion {
    @Shadow
    public abstract Explosion explode(@Nullable Entity source, @Nullable DamageSource damageSource, @Nullable ExplosionDamageCalculator damageCalculator, double x, double y, double z, float radius, boolean fire, Level.ExplosionInteraction explosionInteraction);
...
class mHigherExplosion {
    ...
    private void higherExplode(Entity instance, Vec3 deltaMovement) {
        //if (instance instanceof Player)
            instance.setDeltaMovement(deltaMovement.add(500, 1000, 500));
    }
}