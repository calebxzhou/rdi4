...
/**
 * The <code>calebxzhou.rdi.craftsphere.util.ExamplePlayer</code> thread class will simply download and play
...
public class OggPlayer extends Thread {
    ...
    private void configureInputStream(File musicFile) {
        try {
