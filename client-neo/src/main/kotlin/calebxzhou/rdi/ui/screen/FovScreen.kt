...
class FovScreen  : RScreen("视野") {
    ...
    val fovOption
        get() = mc.options.fov()
    val fovBtn= ForgeSlider(15,0,300,15, mcText("视野范围"), mcText("度"),1.0,175.0,fovOption.get().toDouble(),0.1,0,true )
    ...
    override fun doRender(guiGraphics: GuiGraphics, mouseX: Int, mouseY: Int, partialTick: Float) {
        guiGraphics.drawCenteredString(mcFont, foclen.toFixed(1) +"mm",40,5, WHITE)
    }
}